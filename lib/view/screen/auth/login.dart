import 'package:reserve/controller/auth/login_controller.dart';
import 'package:reserve/controller/test_controller.dart';
...
import 'package:reserve/view/widget/auth/logoauth.dart';
import 'package:reserve/view/widget/auth/textsignup.dart';
...
class Login extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(testController.getData().toString());
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
